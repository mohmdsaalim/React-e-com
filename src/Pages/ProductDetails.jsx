...
// import { FiShoppingCart, FiHeart, FiShare2, FiArrowLeft, FiStar, FiTruck, FiShield, FiRefreshCw } from "react-icons/fi";
...
//       });
//     } else {
//       wishlist.push({ ...product, category: currentCategory });
...
//                 {product.status ? <p>In Stock</p> : <p>Out of Stock</p>}
//                 </span>
//             </div>
...
//                 className="flex-1 flex items-center justify-center space-x-2 py-4 bg-gradient-to-r from-[#004d98] to-[#003366] text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//               >
//                 {addingToCart ? (
...
//                 <div className="flex justify-between">
//                   <span>Material:</span>
//                   <span className="font-medium">{product.materials}</span>{/*.  mettt */}
//                 </div>
//                 <div className="flex justify-between">
//                   <span>Care:</span>
...
//               <button
//                 onClick={handleAddToCart}
//                 disabled={addingToCart || !selectedSize || !product.status || !currentUser}
//                 className="flex-1 flex items-center justify-center space-x-2 py-4 bg-gradient-to-r from-[#004d98] to-[#003366] text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//               >
//                 {addingToCart ? (
//                   <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
...
//   // Check if item is in cart using Cart Context
//   const itemInCart = isInCart(product?.id, selectedSize);

//   const getButtonText = () => {
//     if (!currentUser) return "LOGIN TO ADD";
//     if (!product?.status) return "OUT OF STOCK";
//     if (itemInCart) return "GO TO CART";
//     if (!selectedSize) return "SELECT SIZE";
//     return "ADD TO CART";
//   };

//   const getButtonIcon = () => {
//     if (itemInCart) return <FiCheck className="w-5 h-5" />;
//     if (addingToCart) return <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>;
//     return <FiShoppingCart className="w-5 h-5" />;
//   };
...
//               <button
//                 onClick={handleAddToCart}
//                 disabled={(!selectedSize || !product.status || !currentUser || addingToCart) && !itemInCart}
//                 className={getButtonStyle()}
//               >
//                 {getButtonIcon()}
//                 <span>{getButtonText()}</span>
...
//       if (success) {
//         // Also update Cart Context for immediate UI update
//         addToCart(cartItem);
