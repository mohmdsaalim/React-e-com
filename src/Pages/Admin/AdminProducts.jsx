...
//     try {
//       await axios.patch(`http://localhost:3000/products/kids_kits/${productId}`, {
//         status: newStatus === 'in_stock',
//         stock_quantity: newStatus === 'in_stock'
//       });
      
//       setProducts(prev => prev.map(product => 
//         product.id === productId ? { ...product, status: newStatus === 'in_stock' } : product
//       ));
...
//       const response = await axios.post(`http://localhost:3000/products/${collection}`, newProduct);
//       setProducts(prev => [...prev, { ...response.data, collection }]);
...
//             setProducts(prev => prev.map(p => p.id === updatedProduct.id ? { ...updatedProduct, collection: p.collection } : p));
